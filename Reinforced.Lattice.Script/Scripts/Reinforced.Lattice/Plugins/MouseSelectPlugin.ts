module Reinforced.Lattice.Plugins.MouseSelect {
    export class MouseSelectPlugin extends Reinforced.Lattice.Plugins.PluginBase<Reinforced.Lattice.Plugins.MouseSelect.IMouseSelectUiConfig> {
        ...
        afterDrawn: (e: ITableEventArgs<any>) => void = (a) => {
            Reinforced.Lattice.Services.EventsDelegatorService.addHandler(this.MasterTable.Renderer.RootElement, "mousedown", (e: MouseEvent) => {
            ...
            Reinforced.Lattice.Services.EventsDelegatorService.addHandler(this.MasterTable.Renderer.RootElement, "mousemove", (e: MouseEvent) => {
                if (this._isSelecting) {
                    e.stopPropagation();
                    e.preventDefault();
                }
            ...
            Reinforced.Lattice.Services.EventsDelegatorService.addHandler(document.documentElement, "mouseup", (e: MouseEvent) => {
