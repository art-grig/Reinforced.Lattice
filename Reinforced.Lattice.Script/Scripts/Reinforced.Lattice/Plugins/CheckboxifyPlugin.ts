module Reinforced.Lattice.Plugins.Checkboxify {
    export class CheckboxifyPlugin extends Reinforced.Lattice.Plugins.PluginBase<Reinforced.Lattice.Plugins.Checkboxify.ICheckboxifyUiConfig> {
    ...
    interface ISpecialHeader extends IColumnHeader {
        selectAllEvent(e: Reinforced.Lattice.ITemplateBoundEvent): void;
    }
