module Reinforced.Lattice {
    ...
    export class ComponentsContainer {
         ...
         * @returns {} 
         */
        public static registerComponentEvents(key: string, eventsManager: Reinforced.Lattice.Services.EventsService, masterTable: IMasterTable) {
            if (this._components[key] == null || this._components[key] == undefined)
                throw new Error(`Component ${key} is not registered. Please ensure that you have connected all the additional scripts`);
         ...
         * @internal
         */
        public static registerAllEvents(eventsManager: Reinforced.Lattice.Services.EventsService, masterTable: IMasterTable) {
