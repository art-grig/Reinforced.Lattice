module Reinforced.Lattice.Editing.Editors.PlainText {
    ...
    export class PlainTextEditor extends Reinforced.Lattice.Editing.EditorBase<Reinforced.Lattice.Editing.Editors.PlainText.IPlainTextEditorUiConfig> {
        ...
        private _parseFunction: (value: string, column: IColumn, errors: Reinforced.Lattice.Editing.IValidationMessage[]) => any;
        ...
        private defaultParse(value: string, column: IColumn, errors: Reinforced.Lattice.Editing.IValidationMessage[]): any {
