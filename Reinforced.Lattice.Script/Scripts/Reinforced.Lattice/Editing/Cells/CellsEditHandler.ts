module Reinforced.Lattice.Editing.Editors.Cells {
    export class CellsEditHandler extends EditHandlerBase<Reinforced.Lattice.Editing.Cells.ICellsEditUiConfig>
        implements IAdditionalRowsProvider
    {
        ...
        private beginCellEdit(column: IColumn, rowIndex: number): Reinforced.Lattice.Editing.IEditor {
        ...
        private finishEditing(editor: Reinforced.Lattice.Editing.IEditor, redraw: boolean) {
