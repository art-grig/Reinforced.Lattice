module Reinforced.Lattice.Rendering {
    ...
    export class BackBinder {
        private _dateService: Reinforced.Lattice.Services.DateService;
        ...
        */
         ...
         * @returns {} 
         */
        public backBind(parentElement: HTMLElement, info: Reinforced.Lattice.Templating.IBackbindInfo): void {
        ...
        //#region Datepickers
        private backbindDatepickers(parentElement: HTMLElement, info: Reinforced.Lattice.Templating.IBackbindInfo) {
            var elements = this.getMatchingElements(parentElement, 'data-dp');
            // back binding of datepickers
            this.traverseBackbind<Reinforced.Lattice.Templating.IBackbindDatepicker>(elements, parentElement, info.DatepickersQueue, 'data-dp', (b, e) => {
        ...
        //#region Marks
        private backbindMark(parentElement: HTMLElement, info: Reinforced.Lattice.Templating.IBackbindInfo) {
            var elements = this.getMatchingElements(parentElement, 'data-mrk');
            // back binding of componens needed HTML elements
            this.traverseBackbind<Reinforced.Lattice.Templating.IBackbindMark>(elements, parentElement, info.MarkQueue, 'data-mrk', (b, e) => {
        ...
        //#region Callbacks
        private backbindCallbacks(parentElement: HTMLElement, info: Reinforced.Lattice.Templating.IBackbindInfo) {
            var elements = this.getMatchingElements(parentElement, `data-cb`);
            this.traverseBackbind<Reinforced.Lattice.Templating.IBackbindCallback>(elements, parentElement, info.CallbacksQueue, 'data-cb', (b, e) => {
            ...
            this.traverseBackbind<Reinforced.Lattice.Templating.IBackbindCallback>(elements, parentElement, info.DestroyCallbacksQueue, 'data-dcb', (b, e) => {
        ...
        //#region Events
        private backbindEvents(parentElement: HTMLElement, info: Reinforced.Lattice.Templating.IBackbindInfo) {
            var elements = this.getMatchingElements(parentElement, `data-evb`);
            // backbinding of events
            this.traverseBackbind<Reinforced.Lattice.Templating.IBackbindEvent>(elements, parentElement, info.EventsQueue, 'data-be',
        ...
        private backbindVisualStates(parentElement: HTMLElement, info: Reinforced.Lattice.Templating.IBackbindInfo) {
        ...
        private addNormalState(states: { [key: string]: Reinforced.Lattice.Templating.IState[] }, target: any) {
            var normalState: Reinforced.Lattice.Templating.IState[] = [];
                ...
                if (states.hasOwnProperty(sk)) {
                    for (var i = 0; i < states[sk].length; i++) {
                        ...
                        if (stateIdx < 0) {
                            ...
                            var newEntry: Reinforced.Lattice.Templating.IState = {
        ...
        private mixinToNormal(normal: Reinforced.Lattice.Templating.IState, custom: Reinforced.Lattice.Templating.IState) {
            if (custom.attrs) {
