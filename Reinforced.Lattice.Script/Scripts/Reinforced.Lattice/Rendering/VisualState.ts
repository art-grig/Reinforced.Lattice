module Reinforced.Lattice.Rendering {
    ...
    export class VisualState {
        ...
        */
        ...
        public States: { [key: string]: Reinforced.Lattice.Templating.IState[] } = {};
        ...
        private applyState(desired: Reinforced.Lattice.Templating.IState[]) {
            for (var i = 0; i < desired.length; i++) {
                var ns: Reinforced.Lattice.Templating.IState = desired[i];
