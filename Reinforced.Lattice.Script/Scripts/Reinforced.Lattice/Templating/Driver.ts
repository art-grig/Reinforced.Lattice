module Reinforced.Lattice.Templating {
    export class Driver {
        public static body(p: Reinforced.Lattice.Templating.TemplateProcess) {
            p.w('<input type="hidden" data-track="tableBodyHere" style="display:none;"/>');
        }

        public static content(p: Reinforced.Lattice.Templating.TemplateProcess, columnName?: string) {
        ...
        public static row(p: Reinforced.Lattice.Templating.TemplateProcess, row: IRow) {
            p.nestElement(row, p.Executor.obtainRowTemplate(row), RenderedObject.Row);
        }

        public static headerContent(head: IColumnHeader, p: Reinforced.Lattice.Templating.TemplateProcess) {
            var content = head.Column.Configuration.Title || head.Column.RawName;
            p.w(content);
        }

        public static rowContent(row: IRow, p: Reinforced.Lattice.Templating.TemplateProcess, columnName?: string) {
        ...
        public static colHeader(p: Reinforced.Lattice.Templating.TemplateProcess, columnName: string): void {
            try {
         ...
         * @returns {} 
         */
        public static header(p: Reinforced.Lattice.Templating.TemplateProcess, column: IColumn): void {
