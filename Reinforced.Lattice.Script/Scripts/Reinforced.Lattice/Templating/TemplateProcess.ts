module Reinforced.Lattice.Templating {
    export class TemplateProcess {
        ...
        private _stack: Reinforced.Lattice.Templating.RenderingStack;
        public Html: string = '';
        public w: IWriteFn;
        public s: IWriteFn;
        public Context: IRenderingContext;
        public BackInfo: Reinforced.Lattice.Templating.IBackbindInfo;
        ...
        public vs(stateName: string, state: Reinforced.Lattice.Templating.IState): void {
        ...
        public e(commaSeparatedFunctions: string, commaSeparatedEvents: string, eventArgs: any[]): void {
            var ed: Reinforced.Lattice.Templating.IBackbindEvent = <Reinforced.Lattice.Templating.IBackbindEvent>{
        ...
        public m(fieldName: string, key: string, receiverPath: string) {
            ...
            var md: Reinforced.Lattice.Templating.IBackbindMark = <Reinforced.Lattice.Templating.IBackbindMark>{
        ...
        public dp(condition: boolean, nullable: boolean) {
            ...
            if (condition) {
                var md: Reinforced.Lattice.Templating.IBackbindDatepicker = <Reinforced.Lattice.Templating.IBackbindDatepicker>{
