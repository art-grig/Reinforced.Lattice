module Reinforced.Lattice.Services {
    ...
    export class EventsDelegatorService {
        ...
        private _locator: Reinforced.Lattice.Rendering.DOMLocator;
        ...
        */
         ...
         */
        public subscribeDestroy(e: HTMLElement, callback: Reinforced.Lattice.Templating.IBackbindCallback): void {
            callback.Element = e;
        ...
        private _destroyCallbacks: Reinforced.Lattice.Templating.IBackbindCallback[] = [];
        /**
         * @internal
         */
