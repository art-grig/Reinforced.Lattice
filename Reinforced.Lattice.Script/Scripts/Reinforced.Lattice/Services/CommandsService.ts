module Reinforced.Lattice.Services {
    export class CommandsService {
        ...
        private _commandsCache: { [_: string]: Reinforced.Lattice.Commands.ICommandDescription }
    ...
    export class ConfirmationWindowViewModel implements Reinforced.Lattice.Editing.IEditHandler {
        ...
        private _commandDescription: Reinforced.Lattice.Commands.ICommandDescription;
        private _config: Reinforced.Lattice.Commands.IConfirmationConfiguration;
        ...
        private _autoformFields: { [_: string]: Reinforced.Lattice.Editing.IEditFieldUiConfigBase } = {};
        ...
        //#region Autoform
        public EditorsSet: { [key: string]: Reinforced.Lattice.Editing.IEditor } = {};
        public ActiveEditors: Reinforced.Lattice.Editing.IEditor[] = [];

        public Editors(p: Reinforced.Lattice.Templating.TemplateProcess): void {
            for (var i = 0; i < this.ActiveEditors.length; i++) {
                this.editor(p, this.ActiveEditors[i]);
            }
        }

        private editor(p: Reinforced.Lattice.Templating.TemplateProcess, editor: Reinforced.Lattice.Editing.IEditor): void {
            editor['_IsRendered'] = true;
            editor.renderContent(p);
        }

        public Editor(p: Reinforced.Lattice.Templating.TemplateProcess, fieldName: string): void {
            var editor = this.EditorsSet[fieldName];
            if (editor == null || editor == undefined) return;
            this.editor(p, editor);
        }

        private createEditor(fieldName: string, column: IColumn): Reinforced.Lattice.Editing.IEditor {
        ...
        private produceAutoformColumns(autoform: Reinforced.Lattice.Commands.ICommandAutoformConfiguration) {
        ...
        private initAutoform(autoform: Reinforced.Lattice.Commands.ICommandAutoformConfiguration) {
            var fields = autoform.Autoform;
            for (var i = 0; i < fields.length; i++) {
        ...
        private retrieveEditorData(editor: Reinforced.Lattice.Editing.IEditor, errors?: Reinforced.Lattice.Editing.IValidationMessage[]) {
