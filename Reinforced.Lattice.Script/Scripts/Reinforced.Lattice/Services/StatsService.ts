module Reinforced.Lattice.Services {
    export class StatsService implements Reinforced.Lattice.IStatsModel {
        ...
        public IsAllDataLoaded(): boolean {
            if (this._master.Configuration.Partition.Type === Reinforced.Lattice.PartitionType.Client) return true;
