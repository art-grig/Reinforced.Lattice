...
namespace Reinforced.Lattice.Templates.Plugins.Hideout
{
    ...
    public static class HideoutTemplateExtensions
    {
        ...
        /// <returns></returns>
        public static Inline BindHide<T>(this T t, string eventId)
        ...
        /// <param name="eventId">DOM event id</param>
        /// <returns></returns>
        public static Inline BindShow<T>(this T t, string eventId)
            where T : IModelProvider<IHideoutColumnState>, IProvidesEventsBinding
        {
        ...
        /// <param name="eventId">DOM event id</param>
        /// <returns></returns>
        public static Inline BindToggle<T>(this T t, string eventId)
            where T : IModelProvider<IHideoutColumnState>, IProvidesEventsBinding
        {
        ...
        /// <returns></returns>
        public static Inline BindHide<T>(this T t, string eventId, string columnName)
        ...
        /// <returns></returns>
        public static Inline BindShow<T>(this T t, string eventId, string columnName)
            where T : IModelProvider<IHideoutViewModel>, IProvidesEventsBinding
        {
        ...
        /// <returns></returns>
        public static Inline BindToggle<T>(this T t, string eventId, string columnName)
            where T : IModelProvider<IHideoutViewModel>, IProvidesEventsBinding
        {
        ...
        /// <returns></returns>
        public static CodeBlock IfColumnVisible(this IModelProvider<IHideoutViewModel> t, string columnName)
        {
            return new CodeBlock(string.Format("if (o.isColVisible('{0}')) {{ ", columnName), "}", t);
        }
    }
}
