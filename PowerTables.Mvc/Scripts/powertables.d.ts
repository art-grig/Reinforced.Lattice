...
declare module PowerTables.Templating {
    class Driver {
        ...
        static plugins(p: TemplateProcess, pluginPosition: string): string;
        static renderPlugin(p: TemplateProcess, plugin: IPlugin): void;
        static headerHelper(p: PowerTables.Templating.TemplateProcess, columnName: string): void;
        /**
...
declare module PowerTables.Services {
    ...
    class EventsDelegatorService {
         ...
         */
        subscribeDestroy(e: HTMLElement, callback: PowerTables.Templating.ICallbackDescriptor): void;
        /**
         * @internal
         */
