    ...
    interface IEditionResult {
        ...
        */
        OtherTablesAdjustments: {
            [key: string]: PowerTables.Editing.IAdjustmentData;
        };
    }
...
declare module PowerTables.Editing {
    class EditHandlerBase<TConfiguration extends PowerTables.Editing.IEditFormUiConfigBase> extends PowerTables.Plugins.PluginBase<TConfiguration> implements IEditHandler {
        ...
        protected dispatchEditResponse(editResponse: PowerTables.Editing.IEditionResult, then: () => void): void;
        protected sendDataObjectToServer(then: () => void): void;
        protected createEditor(fieldName: string, column: IColumn, canComplete: boolean, editorType: EditorMode): PowerTables.Editors.ICellEditor;
        protected retrieveEditorData(editor: PowerTables.Editors.ICellEditor, errors?: IValidationMessage[]): void;
        init(masterTable: IMasterTable): void;
    }
...
declare module PowerTables.Editing {
    class EditorBase<T> extends PowerTables.Plugins.PluginBase<T> implements PowerTables.Editing.IEditor {
        /**
...
declare module PowerTables.Editors.Check {
    class CheckEditor extends PowerTables.Editors.CellEditorBase<PowerTables.Editing.Editors.Check.ICheckEditorUiConfig> {
...
declare module PowerTables.Editors.Memo {
    class MemoEditor extends PowerTables.Editors.CellEditorBase<PowerTables.Editing.Editors.Memo.IMemoEditorUiConfig> {
...
declare module PowerTables.Editors.PlainText {
    class PlainTextEditor extends PowerTables.Editors.CellEditorBase<PowerTables.Editing.Editors.PlainText.IPlainTextEditorUiConfig> {
...
declare module PowerTables.Editors.SelectList {
    class SelectListEditor extends PowerTables.Editors.CellEditorBase<PowerTables.Editing.Editors.SelectList.ISelectListEditorUiConfig> {
...
declare module PowerTables.Editors {
    class Editor extends PowerTables.Plugins.PluginBase<PowerTables.Editing.IEditorUiConfig> implements IRow {
        Cells: {
            [key: string]: ICell;
        };
        DataObject: any;
