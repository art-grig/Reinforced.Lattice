...
declare module PowerTables.Plugins.Hierarchy {
    ...
    class HierarchyPlugin2 extends PluginBase<IHierarchyUiConfiguration> implements IClientFilter {
        private _parentKeyFunction;
        ...
        collapseRow(args: IRowEventArgs): void;
        toggleRow(args: IRowEventArgs): void;
        toggleSubtreeByObject(dataObject: IHierarchyData, turnOpen?: boolean): void;
