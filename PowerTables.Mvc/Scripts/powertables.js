...
(function (PowerTables) {
    ...
    })(PowerTables.SelectAllBehavior || (PowerTables.SelectAllBehavior = {}));
    var SelectAllBehavior = PowerTables.SelectAllBehavior;
    ...
    })(PowerTables.ResetSelectionBehavior || (PowerTables.ResetSelectionBehavior = {}));
    var ResetSelectionBehavior = PowerTables.ResetSelectionBehavior;
    ...
    })(PowerTables.PartitionType || (PowerTables.PartitionType = {}));
    var PartitionType = PowerTables.PartitionType;
            ...
            var HierarchyPlugin = (function (_super) {
                ...
                HierarchyPlugin.prototype.expand = function (dataObject, redraw) {
                    ...
                    if (redraw) {
                        ...
                        var newDd = this.MasterTable.DataHolder.DisplayedData.splice(pos, 0, newNodes);
                    }
                };
                ...
                //#region Collapse
                HierarchyPlugin.prototype.collapse = function (dataObject) {
                ...
                HierarchyPlugin.prototype.onFiltered_after = function () {
                    ...
                    for (var j = 0; j < src.length; j++) {
                        if (addParents[src[j].__i])
                            delete addParents[src[j].__i];
                        else {
...
(function (PowerTables) {
    ...
    (function (Plugins) {
        var Hierarchy;
        (function (Hierarchy) {
            var HierarchyPlugin2 = (function (_super) {
                __extends(HierarchyPlugin2, _super);
                function HierarchyPlugin2() {
                    _super.apply(this, arguments);
                ...
                HierarchyPlugin2.prototype.expandRow = function (args) {
                    this.toggleSubtreeByObject(this.MasterTable.DataHolder.StoredData[args.Row], true);
                };
                HierarchyPlugin2.prototype.collapseRow = function (args) {
                    this.toggleSubtreeByObject(this.MasterTable.DataHolder.StoredData[args.Row], false);
                };
                HierarchyPlugin2.prototype.toggleRow = function (args) {
                    this.toggleSubtreeByObject(this.MasterTable.DataHolder.StoredData[args.Row], null);
                };
                HierarchyPlugin2.prototype.toggleSubtreeByObject = function (dataObject, turnOpen) {
                    if (dataObject == null || dataObject == undefined)
                        return;
                    if (turnOpen == null || turnOpen == undefined)
                        turnOpen = !dataObject.IsVisible;
                ...
                HierarchyPlugin2.prototype.expand = function (dataObject) {
                    dataObject.IsExpanded = true;
                    if (this.Configuration.ExpandBehavior === Hierarchy.NodeExpandBehavior.AlwaysLoadRemotely ||
                ...
                HierarchyPlugin2.prototype.toggleVisibleRec = function (dataObject) {
                ...
                HierarchyPlugin2.prototype.collapse = function (dataObject) {
                    this.collapseChildren(dataObject);
                    dataObject.IsExpanded = false;
                    this.MasterTable.Controller.redrawVisibleDataObject(dataObject);
                };
                HierarchyPlugin2.prototype.collapseChildren = function (dataObject) {
                ...
                //#endregion
                HierarchyPlugin2.prototype.init = function (masterTable) {
                    _super.prototype.init.call(this, masterTable);
                    this._parentKeyFunction = this.MasterTable.DataHolder
                        .compileKeyFunction(this.Configuration.ParentKeyFields);
                    this.MasterTable.DataHolder.registerClientOrdering("TreeOrder", this.hierarchicalOrder.bind(this));
                };
                HierarchyPlugin2.prototype.hierarchicalOrder = function (a, b) {
                    if (!this._hierarchyFiltered)
                        return 0;
                    return a._order - b._order;
                };
                HierarchyPlugin2.prototype.refilterStoredData = function () {
                ...
                HierarchyPlugin2.prototype.stackOrder = function (data) {
                    var stack = [];
                ...
                HierarchyPlugin2.prototype.recalculateSubtreeReferences = function (e) {
                    if (this._hierarchyFiltered)
                        return;
                ...
                HierarchyPlugin2.prototype.stealFilterFunctions = function () {
                ...
                HierarchyPlugin2.prototype.onAfterClientDataProcessing = function (e) {
                    this.recalculateSubtreeReferences(e.EventArgs);
                };
                HierarchyPlugin2.prototype.subscribe = function (e) {
                ...
                HierarchyPlugin2.prototype.onAfterLayoutRendered = function () {
                    this.stealFilterFunctions();
                };
                HierarchyPlugin2.prototype.filterPredicate = function (rowObject, query) {
                ...
                HierarchyPlugin2.prototype.onBeforeClientDataProcessing = function () {
                    var d = this.MasterTable.DataHolder.StoredData;
                    for (var i = 0; i < d.length; i++) {
                        var idx = d[i]['__i'];
                        this._children[idx] = [];
                ...
                return HierarchyPlugin2;
            }(Plugins.PluginBase));
            Hierarchy.HierarchyPlugin2 = HierarchyPlugin2;
        })(Hierarchy = Plugins.Hierarchy || (Plugins.Hierarchy = {}));
    })(Plugins = PowerTables.Plugins || (PowerTables.Plugins = {}));
})(PowerTables || (PowerTables = {}));
var PowerTables;
            ...
            var LoadingOverlapPlugin = (function (_super) {
                ...
                function LoadingOverlapPlugin() {
                    ...
                    this.afterDrawn = function (e) {
                        ...
                        PowerTables.Services.EventsDelegatorService.addHandler(window, 'resize', _this.updateCoordsAll.bind(_this));
                    };
                }
...
(function (PowerTables) {
    ...
    (function (Plugins) {
        ...
        (function (Scrollbar) {
            ...
            PowerTables.ComponentsContainer.registerComponent('Scrollbar', ScrollbarPlugin);
        })(Scrollbar = Plugins.Scrollbar || (Plugins.Scrollbar = {}));
    })(Plugins = PowerTables.Plugins || (PowerTables.Plugins = {}));
})(PowerTables || (PowerTables = {}));
var PowerTables;
...
(function (PowerTables) {
    ...
    var PowerTable = (function () {
        ...
        PowerTable.prototype.initialize = function () {
            ...
            this.Renderer = new PowerTables.Rendering.Renderer(this.Configuration.TableRootId, this.Configuration.Prefix, this);
        ...
        var DOMLocator = (function () {
            ...
            */
            ...
            DOMLocator.prototype.getRowElementByObject = function (dataObject) {
                var track = PowerTables.TrackHelper.getRowTrackByObject(dataObject);
                return this._bodyElement.querySelector("[data-track=\"" + track + "\"]");
            };
        ...
        var LoaderService = (function () {
            ...
            LoaderService.prototype.query = function (callback, queryModifier, errorCallback, force) {
                ...
                if (this._masterTable.Configuration.QueryConfirmation) {
                    this._masterTable.Configuration.QueryConfirmation(data, server ? PowerTables.QueryScope.Server : PowerTables.QueryScope.Client, function () {
                        if (server)
            ...
            LoaderService.prototype.command = function (command, callback, queryModifier, errorCallback, force) {
                ...
                if (this._masterTable.Configuration.QueryConfirmation) {
                    this._masterTable.Configuration.QueryConfirmation(data, PowerTables.QueryScope.Transboundary, function () { return _this.doServerQuery(data, null, callback, errorCallback); });
                }
                else {
    ...
    (function (Services) {
        var StatsService = (function () {
            ...
            StatsService.prototype.IsAllDataLoaded = function () {
                if (this._master.Configuration.Partition.Type === PowerTables.PartitionType.Client)
                    return true;
            };
            return StatsService;
        }());
...
(function (PowerTables) {
    ...
    })(Templating = PowerTables.Templating || (PowerTables.Templating = {}));
})(PowerTables || (PowerTables = {}));
var PowerTables;
(function (PowerTables) {
    var Templating;
            ...
            RenderingStack.prototype.getTrack = function (elementType, element) {
                ...
                switch (elementType) {
                    ...
                    case Templating.RenderedObject.Message:
                        trk = PowerTables.TrackHelper.getMessageTrack();
                        break;
