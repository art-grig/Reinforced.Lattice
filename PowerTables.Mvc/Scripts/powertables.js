...
(function (PowerTables) {
    ...
    (function (Templating) {
        ...
        (function (RenderedObject) {
             ...
             */
            RenderedObject[RenderedObject["Custom"] = 5] = "Custom";
...
(function (PowerTables) {
    ...
    (function (Templating) {
        var _ltcTpl = (function () {
            ...
            _ltcTpl.executor = function (prefix, instances) {
                if (!_ltcTpl._lib.hasOwnProperty(prefix)) {
                    throw new Error("Cannot find templates set with prefix " + prefix);
                }
                return new Templating.TemplatesExecutor(_ltcTpl._lib[prefix], instances);
            };
            _ltcTpl._lib = {};
            return _ltcTpl;
        }());
    ...
    (function (Services) {
        ...
        var LoaderService = (function () {
            ...
            LoaderService.prototype.query = function (callback, queryModifier, errorCallback, force) {
                ...
                this._masterTable.Partition.partitionBeforeQuery(serverQuery, PowerTables.QueryScope.Server);
                this._masterTable.Partition.partitionBeforeQuery(clientQuery, PowerTables.QueryScope.Client);
        ...
        var SelectionService = (function () {
            function SelectionService(masterTable) {
                ...
                if (this._configuration.ResetSelectionBehavior ===
                    ...
                    masterTable.Events.DataReceived.subscribe(function (x) {
...
(function (PowerTables) {
    ...
    (function (Rendering) {
        ...
        var BackBinder = (function () {
            ...
            * @internal
            */
            function BackBinder(instances, dateService) {
    ...
    (function (Rendering) {
        ...
        var Renderer = (function () {
            function Renderer(rootId, prefix, masterTable) {
                ...
                this.BackBinder = new Rendering.BackBinder(this._instances, this._masterTable.Date);
            }
    ...
    var PowerTable = (function () {
        ...
        PowerTable.prototype.initialize = function () {
            ...
            this.Partition.initial(this._configuration.Partition
                .InitialSkip, this._configuration.Partition.InitialTake);
    ...
    (function (Plugins) {
        ...
        (function (Paging) {
            var PagingPlugin = (function (_super) {
                ...
                PagingPlugin.prototype.CurrentPage = function () { return this.getCurrentPage() + 1; };
                PagingPlugin.prototype.TotalPages = function () { return this.getTotalPages(); };
                ...
                PagingPlugin.selectedPage = function (skip, take) {
                    if (take === 0)
                        return 0;
                    if (skip < take)
                        return 0;
                ...
                PagingPlugin.prototype.getTotalPages = function () {
                    if (this.MasterTable.Partition.Take === 0)
                        return 1;
                    var tp = this.MasterTable.Partition.amount() / this.MasterTable.Partition.Take;
                    if (tp !== Math.floor(tp)) {
                        tp = Math.floor(tp) + 1;
                    }
                    return tp;
                ...
                PagingPlugin.prototype.nextClick = function (e) {
                    if (this.getCurrentPage() < this.getTotalPages())
                        this.goToPage((this.getCurrentPage() + 1).toString());
                };
                ...
                PagingPlugin.prototype.validateGotopage = function () {
                    var v = this.GotoInput.value;
                    var i = parseInt(v);
                    var valid = this.MasterTable.Partition.isAmountFinite() ? (!isNaN(i) && (i > 0) && (i <= this.getTotalPages())) : true;
                    if (valid) {
    ...
    (function (Plugins) {
        ...
        (function (Scrollbar) {
            var ScrollbarPlugin = (function (_super) {
                ...
                ScrollbarPlugin.prototype.upArrowMouseUp = function (t) {
                };
                ScrollbarPlugin.prototype.downArrowMouseDown = function (t) {
                };
                ScrollbarPlugin.prototype.downArrowMouseUp = function (t) {
                };
    ...
    (function (Services) {
        ...
        (function (Partition) {
            var ClientPartitionService = (function () {
                ...
                ClientPartitionService.prototype.partitionBeforeQuery = function (query, scope) {
                    if (scope === PowerTables.QueryScope.Server) {
                        query.Partition = {
                            NoCount: true,
                            Take: 0,
                            Skip: 0
            ...
            var ServerPartitionService = (function (_super) {
                ...
                ServerPartitionService.prototype.setSkip = function (skip) {
                    if (skip + this.Take > this.amount()) {
                        this._masterTable.Loader.query(function (data) { }, function (q) {
                            return q;
                        }, null, true);
                    }
                    _super.prototype.setSkip.call(this, skip);
                };
                ...
                ServerPartitionService.prototype.partitionBeforeQuery = function (query, scope) {
                    if (scope === PowerTables.QueryScope.Server) {
                        query.Partition = {
                ...
                ServerPartitionService.prototype.partitionAfterQuery = function (initialSet, query) {
