    ...
    (function (Services) {
        ...
        (function (Partition) {
            var PartitionIndicatorRow = (function () {
                function PartitionIndicatorRow(masterTable, partitionService) {
                    this.IsSpecial = true;
                    this.Index = 0;
                    this.Cells = {};
            ...
            var ServerPartitionService = (function (_super) {
                ...
                function ServerPartitionService(masterTable) {
                    ...
                    if (this._conf.AppendLoadingRow || this._conf.UseLoadMore) {
                        this._indicator = new Partition.PartitionIndicatorRow(masterTable, this);
                    }
                }
                ...
                ServerPartitionService.prototype.partitionAfterQuery = function (initialSet, query, serverCount) {
                    ...
                    if (this.ActiveClientFiltering) {
                        if (initialSet.length < this.Take * this._conf.LoadAhead) {
                            ...
                            if (this._conf.UseLoadMore) {
                                setTimeout(function () { return _this.showIndication(); }, 50);
                            }
                            else {
                ...
                ServerPartitionService.any = function (o) {
                    for (var k in o)
                ...
                ServerPartitionService.prototype.amount = function () {
                    return this._conf.NoCount ? _super.prototype.amount.call(this) : this._serverTotalCount;
                };
