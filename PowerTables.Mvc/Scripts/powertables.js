...
(function (PowerTables) {
    ...
    (function (Templating) {
        var Driver = (function () {
            ...
            Driver.headerHelper = function (p, columnName) {
                try {
...
(function (PowerTables) {
    ...
    (function (Templating) {
        var TemplateProcess = (function () {
            function TemplateProcess(uiColumns) {
                this.Html = '';
            ...
            TemplateProcess.prototype.vstate = function (stateName, state) {
            ...
            TemplateProcess.prototype.evt = function () {
            ...
            TemplateProcess.prototype.rc = function () {
                var fn = arguments[0];
                var args = [];
            ...
            TemplateProcess.prototype.dc = function () {
                var fn = arguments[0];
                var args = [];
                for (var i = 1; i < arguments.length; i++) {
                    args.push(arguments[i]);
            ...
            TemplateProcess.prototype.mark = function (fieldName, key, receiverPath) {
            ...
            TemplateProcess.prototype.track = function () {
        ...
        var _ltcTpl = (function () {
            ...
            _ltcTpl.executor = function (prefix, instances) {
                ...
                if (!_ltcTpl._executors[prefix]) {
                    _ltcTpl._executors[prefix] = new Templating.TemplatesExecutor(_ltcTpl._lib[prefix], instances);
                }
    ...
    (function (Templating) {
        var TemplatesExecutor = (function () {
            ...
            TemplatesExecutor.prototype.beginProcess = function () {
                return new Templating.TemplateProcess(this._uiColumns);
            };
            ...
            TemplatesExecutor.prototype.execute = function (data, templateId) {
                ...
                var tp = new Templating.TemplateProcess(this._uiColumns);
...
(function (PowerTables) {
    ...
    (function (Rendering) {
        ...
        var DOMModifier = (function () {
            ...
            * @internal
            */
            function DOMModifier(executor, locator, backBinder, instances, ed) {
                this.displayCache = {};
                this._locator = locator;
    ...
    (function (Rendering) {
        ...
        var Renderer = (function () {
            ...
            Renderer.prototype.layout = function () {
                ...
                this.Modifier = new Rendering.DOMModifier(this.Executor, this.Locator, this.BackBinder, this._instances, this.Delegator);
...
(function (PowerTables) {
    ...
    (function (Plugins) {
        ...
        var PluginBase = (function () {
            ...
            PluginBase.prototype.isLocation = function (location) {
                var loc = this.PluginLocation;
            ...
            var CheckboxifyPlugin = (function (_super) {
                ...
                CheckboxifyPlugin.prototype.init = function (masterTable) {
                    ...
                    var header = {
                        ...
                        renderContent: null,
                        renderElement: function (tp) { return tp.nest({ IsAllSelected: _this.MasterTable.Selection.isAllSelected(), CanSelectAll: _this.MasterTable.Selection.canSelectAll() }, _this.Configuration.SelectAllTemplateId); },
