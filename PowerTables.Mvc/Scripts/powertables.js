...
(function (PowerTables) {
    var Commands;
    (function (Commands) {
        var CommandsConfirmationWindowViewModel = (function () {
            function CommandsConfirmationWindowViewModel() {
            }
            return CommandsConfirmationWindowViewModel;
        }());
        Commands.CommandsConfirmationWindowViewModel = CommandsConfirmationWindowViewModel;
...
(function (PowerTables) {
    ...
    (function (Commands) {
        ...
        Commands.CommandsService = CommandsService;
    })(Commands = PowerTables.Commands || (PowerTables.Commands = {}));
})(PowerTables || (PowerTables = {}));
PowerTables.Commands['extendCommandViewModel'] = function (commandViewModelObject) {
    return null;
};
var PowerTables;
(function (PowerTables) {
    ...
    (function (Editors) {
        ...
        (function (Check) {
            var CheckEditor = (function (_super) {
                ...
                return CheckEditor;
            }(PowerTables.Editors.CellEditorBase));
        ...
        var Editor = (function (_super) {
            ...
            function Editor() {
                ...
                this.afterDrawn = function (e) {
                    _this.MasterTable.Renderer.Delegator.subscribeCellEvent({
                        ...
                        Handler: _this.beginCellEditHandle.bind(_this),
                        Selector: '[data-editcell]',
                        SubscriptionId: 'editor'
                    });
                    _this.MasterTable.Renderer.Delegator.subscribeRowEvent({
                        EventId: _this.Configuration.BeginEditEventId,
                        Handler: _this.beginRowEditHandle.bind(_this),
                        Selector: '[data-editrow]',
                        SubscriptionId: 'editor'
                    });
                    _this.MasterTable.Renderer.Delegator.subscribeRowEvent({
                        EventId: _this.Configuration.CommitEventId,
                        Handler: _this.commitRowEditHandle.bind(_this),
                        Selector: '[data-rowcommit]',
                        SubscriptionId: 'editor'
                    });
                    _this.MasterTable.Renderer.Delegator.subscribeRowEvent({
                        EventId: _this.Configuration.RejectEventId,
                        Handler: _this.rejectRowEditHandle.bind(_this),
            ...
            Editor.prototype.commitAll = function () {
                ...
                this.sendDataObjectToServer(function () {
                    if (!_this._isEditing)
                        _this._currentDataObjectModified = null;
                });
            };
            ...
            Editor.prototype.sendDataObjectToServer = function (then) {
                ...
                this.MasterTable.Loader.requestServer('Edit', function (r) { return _this.dispatchEditResponse(r, then); }, function (q) {
                    q.AdditionalData['Edit'] = JSON.stringify(_this._currentDataObjectModified);
                    return q;
                });
            };
            ...
            Editor.prototype.beginCellEdit = function (column, rowIndex) {
            ...
            Editor.prototype.beginRowEdit = function (rowIndex) {
                this.ensureEditing(rowIndex);
...
(function (PowerTables) {
    ...
    (function (Plugins) {
        var RowAction;
        (function (RowAction_1) {
            var RowAction = (function (_super) {
                __extends(RowAction, _super);
                function RowAction() {
                    _super.apply(this, arguments);
                }
                RowAction.prototype.init = function (masterTable) {
                    _super.prototype.init.call(this, masterTable);
                };
                return RowAction;
            }(PowerTables.Plugins.PluginBase));
            RowAction_1.RowAction = RowAction;
            PowerTables.ComponentsContainer.registerComponent('RowActon', RowAction);
        })(RowAction = Plugins.RowAction || (Plugins.RowAction = {}));
    })(Plugins = PowerTables.Plugins || (PowerTables.Plugins = {}));
})(PowerTables || (PowerTables = {}));
var PowerTables;
(function (PowerTables) {
