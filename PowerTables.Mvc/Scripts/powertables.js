...
(function (PowerTables) {
    ...
    (function (Plugins) {
        ...
        (function (Hierarchy) {
            ...
            (function (TreeFilteringScope) {
                /** Client filtering will be applied to both roots and leafs */
                TreeFilteringScope[TreeFilteringScope["All"] = 0] = "All";
                /** Client filtering will be applied only to leafs */
                TreeFilteringScope[TreeFilteringScope["LeafsOnly"] = 1] = "LeafsOnly";
                /** Client filtering will be applied only to roots */
                TreeFilteringScope[TreeFilteringScope["RootsOnly"] = 2] = "RootsOnly";
            })(Hierarchy.TreeFilteringScope || (Hierarchy.TreeFilteringScope = {}));
            var TreeFilteringScope = Hierarchy.TreeFilteringScope;
