module Reinforced.Lattice.Filters {

    /**
     * Base class for creating filters
     */
    export class FilterBase<T> extends Reinforced.Lattice.Plugins.PluginBase<T> implements IQueryPartProvider, IClientFilter {
