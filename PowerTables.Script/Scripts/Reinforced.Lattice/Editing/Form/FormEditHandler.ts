module Reinforced.Lattice.Editing.Form {
    export class FormEditHandler extends Reinforced.Lattice.Editing.EditHandlerBase<Reinforced.Lattice.Editing.Form.IFormEditUiConfig> {
    ...
    export class FormEditFormModel {
        ...
        private editor(p: Reinforced.Lattice.Templating.TemplateProcess,editor: IEditor): void {
