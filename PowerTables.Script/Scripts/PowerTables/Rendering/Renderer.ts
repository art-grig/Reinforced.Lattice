    ...
    export class Renderer implements ITemplatesProvider {
        ...
        */
        ...
        public layout(): void {
            ...
            this.Modifier = new DOMModifier(this._stack, this.Locator, this.BackBinder, this, this.LayoutRenderer, this._instances, this.Delegator,this.ContentRenderer,this.BodyElement);
