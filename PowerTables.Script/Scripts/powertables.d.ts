/// <reference path="PowerTables/ExternalTypings.d.ts" />
...
declare module PowerTables.Rendering {
    ...
    */
    class TrackHelper {
        ...
        static getCellElement(body: HTMLElement, cell: ICell): HTMLElement;
        static getRowElement(body: HTMLElement, row: IRow): HTMLElement;
        static getColumnCellsElements(body: HTMLElement, column: IColumn): NodeList;
        static getRowCellsElements(body: HTMLElement, row: IRow): NodeList;
        static getHeaderElement(table: HTMLElement, header: IColumnHeader): HTMLElement;
        static getPluginElement(table: HTMLElement, plugin: IPlugin): HTMLElement;
    }
}
declare module PowerTables.Rendering {
    /**
...
declare module PowerTables.Rendering {
    ...
    class LayoutRenderer {
        ...
        private pluginHelperInner(plugin);
