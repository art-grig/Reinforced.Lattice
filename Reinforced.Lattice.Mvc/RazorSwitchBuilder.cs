...
namespace Reinforced.Lattice.Mvc
{
    public class RazorSwitchBuilder
    {
        ...
        {
            _lines.Add(string.Format(" case {0}: return '{1}'; ", Template.CompileExpression(caseExpression, "v", _objectProperty, _defaultProperty), HtmlStringExtensions.SanitizeHtmlString(content)));
        }
        ...
        {
            _default = string.Format(" default: return '{0}'; ", HtmlStringExtensions.SanitizeHtmlString(content(new object())));
            return this;
        }
